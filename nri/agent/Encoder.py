...
from nri.utils import Node2Edge, Edge2Node, fully_connected_edge_index_per_batch
...
class Encoder(nn.Module):
    ...
    def forward(self, x: Tensor, edge_index: Optional[Tensor] = None, batch: Optional[Tensor] = None) -> Tensor:
        """

...
def get_edge_type_probabilities(nri_module: NRIModule, dataset: Dataset, batch_size: int = 64,
    ...
    with torch.no_grad():
        ...
        latent_edge_probs = (running_latent_edge_probs / len(data_loader)).cpu() if running_latent_edge_probs is not None else torch.tensor([])
...
def main(cfg: DictConfig):
    # prepare data
    train_path = to_absolute_path("data/nri_dataset/train_node_features_l2rpn_case14_sandbox_2025-10-21_20:50_with_forecast.npy")
    test_path = to_absolute_path("data/nri_dataset/test_node_features_l2rpn_case14_sandbox_2025-10-21_20:50_with_forecast.npy")

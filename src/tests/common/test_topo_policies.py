...
from src.ra_agents.dqn import RADQN, Sb3DQNTopologyPolicy
from src.ra_agents.ppo import Sb3PPOTopologyPolicy, RAPPO
...
class TestPPOTopoPolicy(unittest.TestCase):
    ...
    def test_forward_ppo(self):
        ppo = RAPPO.load("src/tests/resources/rappo.zip")
    ...
    def test_forward_dqn(self):
        dqn = RADQN.load("src/tests/resources/radqn.zip")

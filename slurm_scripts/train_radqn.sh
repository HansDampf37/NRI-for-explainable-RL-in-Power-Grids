...
priors=(1.0 0.9 0.8 0.7 0.5 0.25 0.0)
...
python test_cuda.py && PYTHONPATH=\$(pwd) python nri/agent/dqn/train_RADQN.py rl.model.name_suffix=${p} rl.model.prior_for_graph_edges_existing=${p}
EOF
done

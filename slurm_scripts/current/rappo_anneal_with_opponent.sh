experiment_name=1901_rainbow_rappo_with_anneal_different_betas_opponent
...
#SBATCH --job-name=ragnn_rb_rb                                           # Name of the job
...
PYTHONPATH=$(pwd) python training_scripts/train_ppo.py -f configs/rappo_anneal_with_opponent.yaml -wd . -s 0 -j 0 --model-type RAGNN --experiment-name ${experiment_name} --opponent
EOF

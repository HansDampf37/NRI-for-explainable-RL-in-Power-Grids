experiment_name=1301_gnnlike_rappo
...
#SBATCH --job-name=gnnlike_rappo                                           # Name of the job
...
PYTHONPATH=$(pwd) python training_scripts/train_ppo.py -f configs/gnnlike_rappo.yaml -wd . -s 0 -j 0 --model-type RAGNN --experiment-name ${experiment_name}
EOF
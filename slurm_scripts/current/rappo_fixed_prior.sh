experiment_name=0802_rappo_fixed_prior
...
PYTHONPATH=$(pwd) python training_scripts/train_ppo.py -f configs/rappo_fixed_prior.yaml -wd . -s 0 -j 0 --model-type RAGNN --experiment-name ${experiment_name}
EOF

experiment_name=2002_rappo_no_prior
...
#SBATCH --job-name=no_prior_s${seed}                                           # Name of the job
...
PYTHONPATH=$(pwd) python training_scripts/train_ppo.py -f configs/rappo_no_prior.yaml -wd . -s ${seed} -j 0 --model-type RAGNN --experiment-name ${experiment_name}
EOF
done

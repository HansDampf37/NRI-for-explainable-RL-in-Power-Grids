...
python test_cuda.py && PYTHONPATH=$(pwd) python baselines/train_stable_baseline.py baseline=gnn_dqn env.safe_max_rho=0.98 baseline.model.name=gnn-dqn-rho98-mazereward_uc3
EOF
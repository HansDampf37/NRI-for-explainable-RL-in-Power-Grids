...
#SBATCH --output=data/${experiment_name}/out/relations_aware/rappo_${p}.%j.log                  # Output file
#SBATCH --error=data/${experiment_name}/out/relations_aware/error_rappo_${p}.%j.log             # Error file
...
#SBATCH --output=data/${experiment_name}/out/relations_unaware/ppo/train_baseline_mlp.%j.log            # Output file
#SBATCH --error=data/${experiment_name}/out/relations_unaware/ppo/error_train_baseline_mlp.%j.log       # Error file
#SBATCH --ntasks=1                                                            # Number of tasks
#SBATCH --gres=gpu:1                                                          # Request 1 GPU
...
#SBATCH --output=data/${experiment_name}/out/relations_unaware/ppo/train_baseline_gnn.%j.log            # Output file
#SBATCH --error=data/${experiment_name}/out/relations_unaware/ppo/error_train_baseline_gnn.%j.log       # Error file
#SBATCH --ntasks=1                                                            # Number of tasks
#SBATCH --gres=gpu:1                                                          # Request 1 GPU
#SBATCH --time=24:00:00                                                       # Max wall time (HH:MM:SS)
#SBATCH --mem=10G                                                             # Memory requirement

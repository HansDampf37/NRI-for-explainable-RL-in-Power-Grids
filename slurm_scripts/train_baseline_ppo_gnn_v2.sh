...
python test_cuda.py && PYTHONPATH=$(pwd) python baselines/train_stable_baseline.py baseline.train.timesteps=600000 baseline=gnn_ppo env.safe_max_rho=0.95 baseline.model.name=gnn-ppo-rho95-mazereward_uc3
EOF